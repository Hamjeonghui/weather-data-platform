...
public class ShortForecastId implements Serializable {
    ...
    public ShortForecastId() {
    }

    public ShortForecastId(Long targetId, String stnId, OffsetDateTime baseAt, OffsetDateTime fcstAt) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ShortForecastId that)) {
            return false;
        }
